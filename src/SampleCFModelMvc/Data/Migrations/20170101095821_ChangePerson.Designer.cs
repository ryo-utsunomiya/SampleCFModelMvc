...
using SampleCFModelMvc.Data;

namespace SampleCFModelMvc.Data.Migrations
{
    [DbContext(typeof(ApplicationDbContext))]
    [Migration("20170101095821_ChangePerson")]
    partial class ChangePerson
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("SampleCFModelMvc.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SampleCFModelMvc.Models.ApplicationUser")
                        .WithMany("Claims")
